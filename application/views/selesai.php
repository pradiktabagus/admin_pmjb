...
<?php include('head.php');?>
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="active">
        <a href="<?php echo base_url()?>selesai">
          <i class="fa fa-flag-checkered"></i><span>Selesai di Kerjakan</span></a>
      </li>
    </ul>
  </section>
  <!-- /.sidebar -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Selesai di Kerjakan</li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="box-body">
          <table id="datatable" class="table table-bordered table-striped">
            ...
            <?php
              $no=1;
              foreach ($data as $row) {
                $status = ($row->status == 0) ? '<label class="label label-warning">UNPROGRESS</label>':'<label class="label label-info">SELESAI</label>';
            ?>  
                <tr>
                  <td><?php echo $no++?></td>
