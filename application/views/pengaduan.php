          ...
          <table id="datatable" class="table table-bordered table-striped">
            ...
            <?php
              ...
              foreach ($data as $row) {
                ...
                // $btn = ($row->status == 0) ? '<a href="'.base_url().'pengaduan/proses_pengaduan/'.$row->id_pengaduan.'" class="btn btn-primary btn-sm">Proses</a>':'<a href="'.base_url().'pengaduan/proses_penyelesaian/'.$row->id_pengaduan.'" class="btn btn-success btn-sm">Selesai</a>';
                $btn = ($row->status == 0) ? '<a onclick="proses_pengaduan('.$id_pengaduan.')" class="btn btn-primary btn-sm">Dikerjakan</a>':'<a onclick="selesai_pengaduan('.$id_pengaduan.')" class="btn btn-success btn-sm">Selesai</a>';
            ?>  
                <tr>
                  <td><?php echo $no++?></td>
...
<!-- Slimscroll -->
<script src="<?php echo base_url()?>assets/bower_components/bootbox/bootbox.min.js" type="text/javascript"></script>
...
<script>
  ...
  function proses_pengaduan(id) {
      bootbox.dialog({
            message : "Anda yakin akan memproses pengaduan ini ?",
            ...
            buttons :{
              danger : {
                  ...
                  className : "blue",
                  callback : function(){
                      window.location.href="<?php echo base_url()?>pengaduan/proses_pengaduan/"+id;
                  }
              },
              main : {
                  label : "Tidak",
    ...
    function selesai_pengaduan(id) {
      bootbox.dialog({
            message : "Anda telah selesai memproses pengaduan ini ?",
            ...
            buttons :{
              danger : {
                  ...
                  className : "blue",
                  callback : function(){
                      window.location.href="<?php echo base_url()?>pengaduan/proses_penyelesaian/"+id;
                  }
              },
              main : {
                  label : "Tidak",
